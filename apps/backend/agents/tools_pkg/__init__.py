"""
Custom MCP Tools for Auto-Marketing Agents
===========================================

This module provides custom MCP tools that agents can use for reliable
operations on auto-marketing data structures. These tools replace prompt-based
...
__all__ = [
    ...
    "ELECTRON_TOOLS",
    "PUPPETEER_TOOLS",
    # Auto-Marketing tool name constants
    "TOOL_UPDATE_SUBTASK_STATUS",
    "TOOL_GET_BUILD_PROGRESS",
    "TOOL_RECORD_DISCOVERY",
    "TOOL_RECORD_GOTCHA",
