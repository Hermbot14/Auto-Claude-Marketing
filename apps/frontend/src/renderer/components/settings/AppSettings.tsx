...
import { ApiSettings } from '../../features/api-settings';
...
export type AppSection = 'appearance' | 'display' | 'language' | 'devtools' | 'agent' | 'paths' | 'accounts' | 'apiSettings' | 'updates' | 'notifications' | 'debug';
