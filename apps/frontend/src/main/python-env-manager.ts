...
/**
 * Manages the Python environment for the auto-marketing backend.
 *
 * For packaged apps:
...
export class PythonEnvManager extends EventEmitter {
  ...
  private async checkDepsInstalled(): Promise<boolean> {
    ...
    try {
      ...
      // See: https://github.com/AndyMik90/Auto-Marketing/issues/359
      //
...
`;
   ...
   *
   * @see https://github.com/AndyMik90/Auto-Marketing/issues/176
   * @see https://github.com/AndyMik90/Auto-Marketing/issues/810
